 ...
 *      RL-ARM - USB
 *----------------------------------------------------------------------------
 *      Name:    usbd_LPC18xx_USB1.c
 *      Purpose: Hardware Layer module for NXP LPC18xx
 *      Rev.:    V4.70
 *----------------------------------------------------------------------------
...
uint8_t __align(4096) EPBufPool[
                                USBD_MAX_PACKET0                                    * 2 + 
                                USBD_HID_ENABLE     *  USBD_HID_WMAXPACKETSIZE      * 2 + 
                                USBD_MSC_ENABLE     *  USBD_MSC_WMAXPACKETSIZE      * 2 + 
                                USBD_ADC_ENABLE     *  USBD_ADC_WMAXPACKETSIZE          + 
                                USBD_CDC_ACM_ENABLE * (USBD_CDC_ACM_WMAXPACKETSIZE      + 
                                                       USBD_CDC_ACM_WMAXPACKETSIZE1 * 2)];
#endif
