...
__inline static void protected_and (uint32_t *addr, uint32_t val) { __disable_irq(); *addr &= val; __enable_irq(); }
__inline static void protected_or  (uint32_t *addr, uint32_t val) { __disable_irq(); *addr |= val; __enable_irq(); }
__inline static void protected_xor (uint32_t *addr, uint32_t val) { __disable_irq(); *addr ^= val; __enable_irq(); }
